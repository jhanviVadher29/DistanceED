    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('student', models.ManyToManyField(to='myAppF23.student')),
            ],
        ),
        migrations.CreateModel(
            name='Course',
            fields=[
                ...
                ('instructor', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, to='myAppF23.instructor')),
